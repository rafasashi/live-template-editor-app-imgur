...
class LTPLE_App_Imgur {
	...
	public function __construct ( $file='', $parent, $version = '1.0.0' ) {
		...
		$this->settings = new LTPLE_App_Imgur_Settings( $this->parent );
		
		$this->admin = new LTPLE_App_Imgur_Admin_API( $this );
		...
		$apps = $this->parent->apps->get_terms( 'app-type', array(
			...
			'imgur' => array(
				...
				'options' 	=> array(
					...
					'thumbnail' => $this->parent->assets_url . 'imgur.jpg',
					'types' 	=> array('images'),
					'api_client'=> 'imgur',
					'parameters'=> array (
	...
	public function get_user_profile_url($app){
		...
		return 'https://' . $app->user_name . '.imgur.com';
	}						
	...
	/**
	 * Main LTPLE_App_Imgur Instance
	 *
	 * Ensures only one instance of LTPLE_App_Imgur is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Imgur()
	 * @return Main LTPLE_App_Imgur instance
	 */
